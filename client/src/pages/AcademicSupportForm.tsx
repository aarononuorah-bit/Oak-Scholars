...
import { CheckCircle, Award, FileText, Briefcase, MessageSquare } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8">
            ...
            <div>
              <label className="block font-semibold text-navy-deep mb-3">
                What do you need help with? <span className="text-amber">*</span>
              </label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-semibold text-navy-deep mb-1.5">Target University (if applicable)</label>
                <Input
              ...
              <div>
                <label className="block text-sm font-semibold text-navy-deep mb-1.5">Target Course (if applicable)</label>
                <Input
                  placeholder="e.g. Law, Medicine, Engineering"
            ...
            <div>
              ...
              <Input
                placeholder="e.g. UCAS deadline Oct 15, or 'as soon as possible'"
                value={form.deadline}
            ...
            <div>
              <label className="block text-sm font-semibold text-navy-deep mb-1.5">Anything else we should know?</label>
              <Textarea
                rows={4}
                placeholder="Tell us about your situation, what stage you're at, or any specific areas you'd like help with..."
                value={form.message}
