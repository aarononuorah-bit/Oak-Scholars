  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
      <div className="p-5 border-b border-gray-50 flex items-center justify-between bg-gray-50/50">
        ...
        <span className="text-[10px] uppercase font-bold tracking-wider text-green-600 bg-green-50 px-2 py-0.5 rounded-full flex items-center gap-1">
          Live Sync Active
        </span>
      </div>
      ...
      <div className="p-5 overflow-x-auto">
        <div className="min-w-[600px] grid grid-cols-7 gap-3">
          {days.map((day) => (
            <div key={day} className="space-y-2 min-h-[150px] bg-surface/30 p-3 rounded-xl border border-gray-50">
